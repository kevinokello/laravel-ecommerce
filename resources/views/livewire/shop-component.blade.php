          ...
          <div class="row">
            <div class="col-lg-9">
              <div class="shop-product-fillter">
                <div class="totall-product">
                  <p>
                    We found <strong class="text-brand">688</strong> items for
                    you!
                  </p>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                  <div class="product-cart-wrap mb-30">
                    ...
                    <div class="product-content-wrap">
                      ...
                      <h2>
                        <a href="product-details.html">Letter Print T-Shirt</a>
                      </h2>
                      <div class="rating-result" title="90%">
                        <span>
                          <span>70%</span>
                ...
                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                  <div class="product-cart-wrap mb-30">
                    ...
                    <div class="product-content-wrap">
                      ...
                      <h2>
                        <a href="product-details.html"
                          >Element Pattern Print Shirts</a
                        >
                      </h2>
                      <div class="rating-result" title="90%">
                        <span>
                ...
                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                  <div class="product-cart-wrap mb-30">
                    ...
                    <div class="product-content-wrap">
                      ...
                      <h2>
                        <a href="product-details.html">Vintage Henley Shirt</a>
                      </h2>
                      <div class="rating-result" title="90%">
                        <span>
                          <span>98%</span>
                ...
                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                  <div class="product-cart-wrap mb-30">
                    ...
                    <div class="product-content-wrap">
                      ...
                      <h2>
                        <a href="product-details.html">Cotton Leaf Printed</a>
                      </h2>
                      <div class="rating-result" title="90%">
                        <span>
                          <span>70%</span>
            ...
            <div class="col-lg-3 primary-sidebar sticky-sidebar">
              ...
              <div class="sidebar-widget price_range range mb-30">
                  ...
                  <div class="list-group-item mb-10 mt-10">
                    ...
                    <div class="custome-checkbox">
                      ...
                      <label class="form-check-label" for="exampleCheckbox21"
                        ><span>Refurbished (27)</span></label
                      >
                      <br />
                      <input
                        class="form-check-input"
                ...
                <a href="shop.html" class="btn btn-sm btn-default"
